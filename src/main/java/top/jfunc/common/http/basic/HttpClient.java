 ...
 * 使用{@link top.jfunc.common.http.req.HttpRequest}子类
...
public interface HttpClient {
     ...
     *               如果是其他的编码请使用{@link SmartHttpClient#get(top.jfunc.common.http.req.HttpRequest)},然后Request中设置bodyCharset
    ...
    /**
     * HTTP GET请求
     * @see HttpClient#get(String, Map, Map, Integer, Integer, String)
     * @param url url
     * @param params params
    ...
    /**
     * HTTP POST form
     * @see HttpClient#post(String, Map, Map, String, String)
     * @param url url
     * @param params params 参数用 =和& 连接
     * @param headers headers
     * @return String
    ...
    /**
     * 下载为字节数组
     * @see HttpClient#getAsBytes(String, MultiValueMap, Integer, Integer)
     * @param url url
     * @param connectTimeout connectTimeout
     * @param readTimeout readTimeout
     * @return byte[]
    ...
    /**
     * 下载为文件
     * @see HttpClient#getAsFile(String, File, Integer, Integer)
     * @param url url
     * @param file file
     * @param connectTimeout connectTimeout
     * @param readTimeout readTimeout
    ...
    /**
     * 上传文件
     * @see HttpClient#upload(String, MultiValueMap, Integer, Integer, String, FormFile...)
     * @param url url
     * @param headers headers
     * @param connectTimeout connectTimeout
     * @param readTimeout readTimeout
    ...
    /**
     * 上传文件和key-value数据
     * @see HttpClient#upload(String, MultiValueMap, MultiValueMap, Integer, Integer, String, FormFile...)
     * @param url url
     * @param params params
     * @param headers headers
     * @param connectTimeout connectTimeout
