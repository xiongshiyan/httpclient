...
public class MediaTypeTest {
    ...
    public void testToString(){
        ...
        Assert.assertThat(MediaType.APPLICATIPON_RDF.toString() , is("application/rdf+xml;charset=utf-8"));
        Assert.assertThat(MediaType.APPLICATIPON_SOAP_XML.toString() , is("application/soap+xml;charset=utf-8"));
